/** Shared marketing copy filters (public UI + scrape pipeline). */
...
/** @param {string | null | undefined} description @param {string | null | undefined} tagline */
export function isUsableDescription(description, tagline) {
