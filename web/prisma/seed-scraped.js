...
export async function runScrapedSeed() {
...

  {
    ...
    await prisma.vehicleModel.upsert({
      where: { id: modelId },
      update: { name: {"vi":"EC Van","en":"EC Van"}, slug: {"vi":"ec-van","en":"ec-van"}, tagline: {"vi":"EC Van Tiện dụng - sinh lời","en":"EC Van Tiện dụng - sinh lời"}, description: {"vi":"EC Van Tiện dụng - sinh lời Hướng dẫn đặt cọc EC Van Link đặt cọc : Đặt cọc Volta EC Van","en":"EC Van Tiện dụng - sinh lời Hướng dẫn đặt cọc EC Van Link đặt cọc : Đặt cọc Volta EC Van"}, attributes: [{"key":"range","value":150,"unit":"km"},{"key":"power","value":30,"unit":"kW"},{"key":"battery","value":17,"unit":"kWh"},{"key":"seats","value":2,"unit":"seats"}], published: true, sortOrder: 1 },
      create: { id: modelId, segmentId: segmentIds["van"], name: {"vi":"EC Van","en":"EC Van"}, slug: {"vi":"ec-van","en":"ec-van"}, tagline: {"vi":"EC Van Tiện dụng - sinh lời","en":"EC Van Tiện dụng - sinh lời"}, description: {"vi":"EC Van Tiện dụng - sinh lời Hướng dẫn đặt cọc EC Van Link đặt cọc : Đặt cọc Volta EC Van","en":"EC Van Tiện dụng - sinh lời Hướng dẫn đặt cọc EC Van Link đặt cọc : Đặt cọc Volta EC Van"}, attributes: [{"key":"range","value":150,"unit":"km"},{"key":"power","value":30,"unit":"kW"},{"key":"battery","value":17,"unit":"kWh"},{"key":"seats","value":2,"unit":"seats"}], published: true, sortOrder: 1 },
    });
    ...
    await prisma.featureSection.upsert({
      ...
      update: { title: {"vi":"Link đặt cọc : Đặt cọc Volta EC Van","en":"Link đặt cọc : Đặt cọc Volta EC Van"}, body: {"vi":"Link đặt cọc : Đặt cọc Volta EC Van","en":"Link đặt cọc : Đặt cọc Volta EC Van"}, sortOrder: 3 },
      create: { id: "seed-feature-ec-van-3", modelId, title: {"vi":"Link đặt cọc : Đặt cọc Volta EC Van","en":"Link đặt cọc : Đặt cọc Volta EC Van"}, body: {"vi":"Link đặt cọc : Đặt cọc Volta EC Van","en":"Link đặt cọc : Đặt cọc Volta EC Van"}, sortOrder: 3 },
    });
    await prisma.featureSection.upsert({
      where: { id: "seed-feature-ec-van-4" },
      update: { title: {"vi":"Volta EC Van Nâng cao Cửa Lùa","en":"Volta EC Van Nâng cao Cửa Lùa"}, body: {"vi":"Volta EC Van Nâng cao Cửa Lùa","en":"Volta EC Van Nâng cao Cửa Lùa"}, sortOrder: 4 },
      create: { id: "seed-feature-ec-van-4", modelId, title: {"vi":"Volta EC Van Nâng cao Cửa Lùa","en":"Volta EC Van Nâng cao Cửa Lùa"}, body: {"vi":"Volta EC Van Nâng cao Cửa Lùa","en":"Volta EC Van Nâng cao Cửa Lùa"}, sortOrder: 4 },
    });
  }
  {
    ...
    await prisma.featureSection.upsert({
      ...
      update: { title: {"vi":"So sánh giữa xe Volta Herio Green và xe động cơ đốt trong","en":"So sánh giữa xe Volta Herio Green và xe động cơ đốt trong"}, body: {"vi":"So sánh giữa xe Volta Herio Green và xe động cơ đốt trong","en":"So sánh giữa xe Volta Herio Green và xe động cơ đốt trong"}, sortOrder: 1 },
      create: { id: "seed-feature-herio-green-1", modelId, title: {"vi":"So sánh giữa xe Volta Herio Green và xe động cơ đốt trong","en":"So sánh giữa xe Volta Herio Green và xe động cơ đốt trong"}, body: {"vi":"So sánh giữa xe Volta Herio Green và xe động cơ đốt trong","en":"So sánh giữa xe Volta Herio Green và xe động cơ đốt trong"}, sortOrder: 1 },
    });
    await prisma.featureSection.upsert({
  ...
  }
  {
    ...
    await prisma.vehicleModel.upsert({
      where: { id: modelId },
      update: { name: {"vi":"Limo Green","en":"Limo Green"}, slug: {"vi":"limo-green","en":"limo-green"}, tagline: {"vi":"Limo Green mang đến trải nghiệm di chuyển vượt trội với khoang xe 7 chỗ rộng rãi, thiết kế tối ưu cho sự thoải mái, tiện","en":"Limo Green mang đến trải nghiệm di chuyển vượt trội với khoang xe 7 chỗ rộng rãi, thiết kế tối ưu cho sự thoải mái, tiện"}, description: {"vi":"Volta Limo Green là mẫu MPV điện 7 chỗ hướng đến gia đình và khách hàng kinh doanh dịch vụ. Xe sở hữu không gian rộng rãi, thiết kế hiện đại và khả năng vận hành êm ái. Bên cạnh đó, chi phí sử dụng tiết kiệm cũng là một lợi thế nổi bật. Limo Green phù hợp cho nhu cầu di chuyển hằng ngày và những chuyến đi dài. Volta Limo Green có kích thước tổng thể 4.740 x 1.872 x 1.728 mm (Dài x Rộng x Cao). Kích thước này lớn hơn nhiều mẫu MPV cỡ nhỏ như Mitsubishi Xpander, Toyota Veloz và Suzuki XL7. So với các mẫu MPV điện cùng phân khúc, Limo Green cũng có lợi thế về không gian. Xe có kích thước nhỉnh hơn BYD M6 và tương đương Toyota Innova Cross. Nhờ đó, cả ba hàng ghế đều mang lại sự thoải mái cho hành khách.","en":"Volta Limo Green là mẫu MPV điện 7 chỗ hướng đến gia đình và khách hàng kinh doanh dịch vụ. Xe sở hữu không gian rộng rãi, thiết kế hiện đại và khả năng vận hành êm ái. Bên cạnh đó, chi phí sử dụng tiết kiệm cũng là một lợi thế nổi bật. Limo Green phù hợp cho nhu cầu di chuyển hằng ngày và những chuyến đi dài. Volta Limo Green có kích thước tổng thể 4.740 x 1.872 x 1.728 mm (Dài x Rộng x Cao). Kích thước này lớn hơn nhiều mẫu MPV cỡ nhỏ như Mitsubishi Xpander, Toyota Veloz và Suzuki XL7. So với các mẫu MPV điện cùng phân khúc, Limo Green cũng có lợi thế về không gian. Xe có kích thước nhỉnh hơn BYD M6 và tương đương Toyota Innova Cross. Nhờ đó, cả ba hàng ghế đều mang lại sự thoải mái cho hành khách."}, attributes: [{"key":"range","value":450,"unit":"km"},{"key":"power","value":150,"unit":"kW"},{"key":"battery","value":13,"unit":"kWh"},{"key":"seats","value":7,"unit":"seats"}], published: true, sortOrder: 3 },
    ...
    await prisma.featureSection.upsert({
      ...
      update: { title: {"vi":"Thiết kế rộng rãi, tối ưu không gian","en":"Thiết kế rộng rãi, tối ưu không gian"}, body: {"vi":"Volta Limo Green có kích thước tổng thể 4.740 x 1.872 x 1.728 mm (Dài x Rộng x Cao). Kích thước này lớn hơn nhiều mẫu MPV cỡ nhỏ như Mitsubishi Xpander, Toyota Veloz và Suzuki XL7.","en":"Volta Limo Green có kích thước tổng thể 4.740 x 1.872 x 1.728 mm (Dài x Rộng x Cao). Kích thước này lớn hơn nhiều mẫu MPV cỡ nhỏ như Mitsubishi Xpander, Toyota Veloz và Suzuki XL7."}, sortOrder: 1 },
      create: { id: "seed-feature-limo-green-1", modelId, title: {"vi":"Thiết kế rộng rãi, tối ưu không gian","en":"Thiết kế rộng rãi, tối ưu không gian"}, body: {"vi":"Volta Limo Green có kích thước tổng thể 4.740 x 1.872 x 1.728 mm (Dài x Rộng x Cao). Kích thước này lớn hơn nhiều mẫu MPV cỡ nhỏ như Mitsubishi Xpander, Toyota Veloz và Suzuki XL7.","en":"Volta Limo Green có kích thước tổng thể 4.740 x 1.872 x 1.728 mm (Dài x Rộng x Cao). Kích thước này lớn hơn nhiều mẫu MPV cỡ nhỏ như Mitsubishi Xpander, Toyota Veloz và Suzuki XL7."}, sortOrder: 1 },
    });
    await prisma.featureSection.upsert({
      where: { id: "seed-feature-limo-green-2" },
      update: { title: {"vi":"Động cơ điện mạnh mẽ, quãng đường lên đến 450 km","en":"Động cơ điện mạnh mẽ, quãng đường lên đến 450 km"}, body: {"vi":"Volta Limo Green sử dụng hệ dẫn động cầu trước. Xe có ba chế độ lái gồm Eco, Comfort và Sport. Người lái có thể dễ dàng lựa chọn chế độ phù hợp với từng điều kiện vận hành.","en":"Volta Limo Green sử dụng hệ dẫn động cầu trước. Xe có ba chế độ lái gồm Eco, Comfort và Sport. Người lái có thể dễ dàng lựa chọn chế độ phù hợp với từng điều kiện vận hành."}, sortOrder: 2 },
      create: { id: "seed-feature-limo-green-2", modelId, title: {"vi":"Động cơ điện mạnh mẽ, quãng đường lên đến 450 km","en":"Động cơ điện mạnh mẽ, quãng đường lên đến 450 km"}, body: {"vi":"Volta Limo Green sử dụng hệ dẫn động cầu trước. Xe có ba chế độ lái gồm Eco, Comfort và Sport. Người lái có thể dễ dàng lựa chọn chế độ phù hợp với từng điều kiện vận hành.","en":"Volta Limo Green sử dụng hệ dẫn động cầu trước. Xe có ba chế độ lái gồm Eco, Comfort và Sport. Người lái có thể dễ dàng lựa chọn chế độ phù hợp với từng điều kiện vận hành."}, sortOrder: 2 },
    });
    await prisma.featureSection.upsert({
      where: { id: "seed-feature-limo-green-3" },
      update: { title: {"vi":"Hệ thống khung gầm vận hành ổn định","en":"Hệ thống khung gầm vận hành ổn định"}, body: {"vi":"Volta Limo Green được trang bị mâm hợp kim 18 inch. Xe sử dụng phanh đĩa trên cả bốn bánh. Phía trước là đĩa thông gió, trong khi phía sau là đĩa tiêu chuẩn.","en":"Volta Limo Green được trang bị mâm hợp kim 18 inch. Xe sử dụng phanh đĩa trên cả bốn bánh. Phía trước là đĩa thông gió, trong khi phía sau là đĩa tiêu chuẩn."}, sortOrder: 3 },
      create: { id: "seed-feature-limo-green-3", modelId, title: {"vi":"Hệ thống khung gầm vận hành ổn định","en":"Hệ thống khung gầm vận hành ổn định"}, body: {"vi":"Volta Limo Green được trang bị mâm hợp kim 18 inch. Xe sử dụng phanh đĩa trên cả bốn bánh. Phía trước là đĩa thông gió, trong khi phía sau là đĩa tiêu chuẩn.","en":"Volta Limo Green được trang bị mâm hợp kim 18 inch. Xe sử dụng phanh đĩa trên cả bốn bánh. Phía trước là đĩa thông gió, trong khi phía sau là đĩa tiêu chuẩn."}, sortOrder: 3 },
    });
    await prisma.featureSection.upsert({
      where: { id: "seed-feature-limo-green-4" },
      update: { title: {"vi":"Hệ thống đèn LED hiện đại","en":"Hệ thống đèn LED hiện đại"}, body: {"vi":"Toàn bộ hệ thống chiếu sáng trên Volta Limo Green đều sử dụng công nghệ LED. Xe được trang bị đèn pha, đèn hậu, đèn ban ngày và đèn phanh trên cao.","en":"Toàn bộ hệ thống chiếu sáng trên Volta Limo Green đều sử dụng công nghệ LED. Xe được trang bị đèn pha, đèn hậu, đèn ban ngày và đèn phanh trên cao."}, sortOrder: 4 },
      create: { id: "seed-feature-limo-green-4", modelId, title: {"vi":"Hệ thống đèn LED hiện đại","en":"Hệ thống đèn LED hiện đại"}, body: {"vi":"Toàn bộ hệ thống chiếu sáng trên Volta Limo Green đều sử dụng công nghệ LED. Xe được trang bị đèn pha, đèn hậu, đèn ban ngày và đèn phanh trên cao.","en":"Toàn bộ hệ thống chiếu sáng trên Volta Limo Green đều sử dụng công nghệ LED. Xe được trang bị đèn pha, đèn hậu, đèn ban ngày và đèn phanh trên cao."}, sortOrder: 4 },
    });
  }
  {
  ...
  }
  {
    ...
    await prisma.featureSection.upsert({
      ...
      update: { title: {"vi":"So sánh giữa xe Volta VF MPV 7 và xe động cơ đốt trong","en":"So sánh giữa xe Volta VF MPV 7 và xe động cơ đốt trong"}, body: {"vi":"So sánh giữa xe Volta VF MPV 7 và xe động cơ đốt trong","en":"So sánh giữa xe Volta VF MPV 7 và xe động cơ đốt trong"}, sortOrder: 1 },
      create: { id: "seed-feature-mpv-7-1", modelId, title: {"vi":"So sánh giữa xe Volta VF MPV 7 và xe động cơ đốt trong","en":"So sánh giữa xe Volta VF MPV 7 và xe động cơ đốt trong"}, body: {"vi":"So sánh giữa xe Volta VF MPV 7 và xe động cơ đốt trong","en":"So sánh giữa xe Volta VF MPV 7 và xe động cơ đốt trong"}, sortOrder: 1 },
    });
    await prisma.featureSection.upsert({
  ...
  }
  {
    ...
    await prisma.vehicleModel.upsert({
      where: { id: modelId },
      update: { name: {"vi":"VF 3","en":"VF 3"}, slug: {"vi":"vf-3","en":"vf-3"}, tagline: {"vi":"Với thiết kế tối giản, nhỏ gọn, cá tính và năng động, Volta VF 3 sẽ luôn cùng bạn hoà nhịp với xu thế công nghệ di chu","en":"Với thiết kế tối giản, nhỏ gọn, cá tính và năng động, Volta VF 3 sẽ luôn cùng bạn hoà nhịp với xu thế công nghệ di chu"}, description: {"vi":"Với thiết kế tối giản, nhỏ gọn, cá tính và năng động, Volta VF 3 sẽ luôn cùng bạn hoà nhịp với xu thế công nghệ di chuyển xanh toàn cầu, trải nghiệm giá trị trên mỗi hành trình, và tự do thể hiện phong cách sống. Với dải màu ngoại thất đa dạng và độc đáo, bao gồm 9 tùy chọn màu sắc trẻ trung và thời thượng, VF 3 là sự lựa chọn hoàn hảo giúp bạn thoả sức thể hiện sự khác biệt và cá tính của riêng mình. Dù bạn là ai, hãy lựa chọn màu sắc và trang bị VF 3 theo sở thích của bạn, và cùng Volta biến ước mơ của bạn thành hiện thực. Volta VF 3 là mẫu xe hiếm hoi trong phân khúc xe sở hữu la-zăng kích thước 16 inch, không chỉ tạo điểm nhấn về thiết kế mà còn góp phần gia tăng khả năng di chuyển trên địa hình đa dạng trong đô thị. Đặc biệt, VF 3 được trang bị tuỳ chọn ốp la-zăng, tăng thêm vẻ cá tính, sự sang trọng cho chiếc xe.","en":"Với thiết kế tối giản, nhỏ gọn, cá tính và năng động, Volta VF 3 sẽ luôn cùng bạn hoà nhịp với xu thế công nghệ di chuyển xanh toàn cầu, trải nghiệm giá trị trên mỗi hành trình, và tự do thể hiện phong cách sống. Với dải màu ngoại thất đa dạng và độc đáo, bao gồm 9 tùy chọn màu sắc trẻ trung và thời thượng, VF 3 là sự lựa chọn hoàn hảo giúp bạn thoả sức thể hiện sự khác biệt và cá tính của riêng mình. Dù bạn là ai, hãy lựa chọn màu sắc và trang bị VF 3 theo sở thích của bạn, và cùng Volta biến ước mơ của bạn thành hiện thực. Volta VF 3 là mẫu xe hiếm hoi trong phân khúc xe sở hữu la-zăng kích thước 16 inch, không chỉ tạo điểm nhấn về thiết kế mà còn góp phần gia tăng khả năng di chuyển trên địa hình đa dạng trong đô thị. Đặc biệt, VF 3 được trang bị tuỳ chọn ốp la-zăng, tăng thêm vẻ cá tính, sự sang trọng cho chiếc xe."}, attributes: [{"key":"seats","value":4,"unit":"seats"}], published: true, sortOrder: 7 },
      create: { id: modelId, segmentId: segmentIds["suv"], name: {"vi":"VF 3","en":"VF 3"}, slug: {"vi":"vf-3","en":"vf-3"}, tagline: {"vi":"Với thiết kế tối giản, nhỏ gọn, cá tính và năng động, Volta VF 3 sẽ luôn cùng bạn hoà nhịp với xu thế công nghệ di chu","en":"Với thiết kế tối giản, nhỏ gọn, cá tính và năng động, Volta VF 3 sẽ luôn cùng bạn hoà nhịp với xu thế công nghệ di chu"}, description: {"vi":"Với thiết kế tối giản, nhỏ gọn, cá tính và năng động, Volta VF 3 sẽ luôn cùng bạn hoà nhịp với xu thế công nghệ di chuyển xanh toàn cầu, trải nghiệm giá trị trên mỗi hành trình, và tự do thể hiện phong cách sống. Với dải màu ngoại thất đa dạng và độc đáo, bao gồm 9 tùy chọn màu sắc trẻ trung và thời thượng, VF 3 là sự lựa chọn hoàn hảo giúp bạn thoả sức thể hiện sự khác biệt và cá tính của riêng mình. Dù bạn là ai, hãy lựa chọn màu sắc và trang bị VF 3 theo sở thích của bạn, và cùng Volta biến ước mơ của bạn thành hiện thực. Volta VF 3 là mẫu xe hiếm hoi trong phân khúc xe sở hữu la-zăng kích thước 16 inch, không chỉ tạo điểm nhấn về thiết kế mà còn góp phần gia tăng khả năng di chuyển trên địa hình đa dạng trong đô thị. Đặc biệt, VF 3 được trang bị tuỳ chọn ốp la-zăng, tăng thêm vẻ cá tính, sự sang trọng cho chiếc xe.","en":"Với thiết kế tối giản, nhỏ gọn, cá tính và năng động, Volta VF 3 sẽ luôn cùng bạn hoà nhịp với xu thế công nghệ di chuyển xanh toàn cầu, trải nghiệm giá trị trên mỗi hành trình, và tự do thể hiện phong cách sống. Với dải màu ngoại thất đa dạng và độc đáo, bao gồm 9 tùy chọn màu sắc trẻ trung và thời thượng, VF 3 là sự lựa chọn hoàn hảo giúp bạn thoả sức thể hiện sự khác biệt và cá tính của riêng mình. Dù bạn là ai, hãy lựa chọn màu sắc và trang bị VF 3 theo sở thích của bạn, và cùng Volta biến ước mơ của bạn thành hiện thực. Volta VF 3 là mẫu xe hiếm hoi trong phân khúc xe sở hữu la-zăng kích thước 16 inch, không chỉ tạo điểm nhấn về thiết kế mà còn góp phần gia tăng khả năng di chuyển trên địa hình đa dạng trong đô thị. Đặc biệt, VF 3 được trang bị tuỳ chọn ốp la-zăng, tăng thêm vẻ cá tính, sự sang trọng cho chiếc xe."}, attributes: [{"key":"seats","value":4,"unit":"seats"}], published: true, sortOrder: 7 },
    });
    await prisma.vehicleVariant.upsert({
    ...
    await prisma.featureSection.upsert({
      ...
      update: { title: {"vi":"Volta VF 3 - Xe nhỏ, giá trị lớn.","en":"Volta VF 3 - Xe nhỏ, giá trị lớn."}, body: {"vi":"Volta VF 3 - Xe nhỏ, giá trị lớn.","en":"Volta VF 3 - Xe nhỏ, giá trị lớn."}, sortOrder: 2 },
      create: { id: "seed-feature-vf-3-2", modelId, title: {"vi":"Volta VF 3 - Xe nhỏ, giá trị lớn.","en":"Volta VF 3 - Xe nhỏ, giá trị lớn."}, body: {"vi":"Volta VF 3 - Xe nhỏ, giá trị lớn.","en":"Volta VF 3 - Xe nhỏ, giá trị lớn."}, sortOrder: 2 },
    });
    await prisma.featureSection.upsert({
      where: { id: "seed-feature-vf-3-3" },
      update: { title: {"vi":"Volta VF 3 - Tự do sáng tạo, toả sáng chất riêng!","en":"Volta VF 3 - Tự do sáng tạo, toả sáng chất riêng!"}, body: {"vi":"Volta VF 3 - Tự do sáng tạo, toả sáng chất riêng!","en":"Volta VF 3 - Tự do sáng tạo, toả sáng chất riêng!"}, sortOrder: 3 },
      create: { id: "seed-feature-vf-3-3", modelId, title: {"vi":"Volta VF 3 - Tự do sáng tạo, toả sáng chất riêng!","en":"Volta VF 3 - Tự do sáng tạo, toả sáng chất riêng!"}, body: {"vi":"Volta VF 3 - Tự do sáng tạo, toả sáng chất riêng!","en":"Volta VF 3 - Tự do sáng tạo, toả sáng chất riêng!"}, sortOrder: 3 },
    });
    await prisma.featureSection.upsert({
  ...
  }
  {
    ...
    await prisma.featureSection.upsert({
      ...
      update: { title: {"vi":"Volta VF 5 Summer Yellow – Nổi bật và tràn đầy năng lượng","en":"Volta VF 5 Summer Yellow – Nổi bật và tràn đầy năng lượng"}, body: {"vi":"Summer Yellow mang đến nguồn năng lượng tích cực và tinh thần chinh phục. Gam vàng nổi bật giúp Volta VF 5 thu hút mọi ánh nhìn trên đường phố.","en":"Summer Yellow mang đến nguồn năng lượng tích cực và tinh thần chinh phục. Gam vàng nổi bật giúp Volta VF 5 thu hút mọi ánh nhìn trên đường phố."}, sortOrder: 4 },
      create: { id: "seed-feature-vf-5-4", modelId, title: {"vi":"Volta VF 5 Summer Yellow – Nổi bật và tràn đầy năng lượng","en":"Volta VF 5 Summer Yellow – Nổi bật và tràn đầy năng lượng"}, body: {"vi":"Summer Yellow mang đến nguồn năng lượng tích cực và tinh thần chinh phục. Gam vàng nổi bật giúp Volta VF 5 thu hút mọi ánh nhìn trên đường phố.","en":"Summer Yellow mang đến nguồn năng lượng tích cực và tinh thần chinh phục. Gam vàng nổi bật giúp Volta VF 5 thu hút mọi ánh nhìn trên đường phố."}, sortOrder: 4 },
    });
  }
  {
    ...
    await prisma.vehicleModel.upsert({
      where: { id: modelId },
      update: { name: {"vi":"VF 6","en":"VF 6"}, slug: {"vi":"vf-6","en":"vf-6"}, tagline: {"vi":"Vui lòng gọi số Hotline 09.012.7777.3 để nhận ưu đãi và báo giá:","en":"Vui lòng gọi số Hotline 09.012.7777.3 để nhận ưu đãi và báo giá:"}, description: {"vi":"480 km/lần sạcDung lượng pinVF 6 Eco 150kW/201 hpCông suất tối đaVF 6 Plus Volta VF6 là tuyệt tác nghệ thuật được thiết kế dựa trên triết lý “Cặp đối lập tự nhiên”, tạo nên sự cân bằng hoàn hảo giữa các yếu tố tưởng chừng như đối lập: thú vị – tinh tế, công nghệ – con người.","en":"480 km/lần sạcDung lượng pinVF 6 Eco 150kW/201 hpCông suất tối đaVF 6 Plus Volta VF6 là tuyệt tác nghệ thuật được thiết kế dựa trên triết lý “Cặp đối lập tự nhiên”, tạo nên sự cân bằng hoàn hảo giữa các yếu tố tưởng chừng như đối lập: thú vị – tinh tế, công nghệ – con người."}, attributes: [{"key":"range","value":480,"unit":"km"},{"key":"power","value":150,"unit":"kW"}], published: true, sortOrder: 9 },
  ...
  }
  {
    ...
    await prisma.featureSection.upsert({
      ...
      update: { title: {"vi":"VF 7 là một bước tiến đột phá trong thiết kế xe ô tô của Volta.","en":"VF 7 là một bước tiến đột phá trong thiết kế xe ô tô của Volta."}, body: {"vi":"VF 7 là một bước tiến đột phá trong thiết kế xe ô tô của Volta.","en":"VF 7 là một bước tiến đột phá trong thiết kế xe ô tô của Volta."}, sortOrder: 2 },
      create: { id: "seed-feature-vf-7-2", modelId, title: {"vi":"VF 7 là một bước tiến đột phá trong thiết kế xe ô tô của Volta.","en":"VF 7 là một bước tiến đột phá trong thiết kế xe ô tô của Volta."}, body: {"vi":"VF 7 là một bước tiến đột phá trong thiết kế xe ô tô của Volta.","en":"VF 7 là một bước tiến đột phá trong thiết kế xe ô tô của Volta."}, sortOrder: 2 },
    });
    await prisma.featureSection.upsert({
    ...
    await prisma.featureSection.upsert({
      ...
      update: { title: {"vi":"VF 7 là một bước tiến đột phá trong thiết kếxe ô tô của Volta.","en":"VF 7 là một bước tiến đột phá trong thiết kếxe ô tô của Volta."}, body: {"vi":"VF 7 là một bước tiến đột phá trong thiết kếxe ô tô của Volta.","en":"VF 7 là một bước tiến đột phá trong thiết kếxe ô tô của Volta."}, sortOrder: 4 },
      create: { id: "seed-feature-vf-7-4", modelId, title: {"vi":"VF 7 là một bước tiến đột phá trong thiết kếxe ô tô của Volta.","en":"VF 7 là một bước tiến đột phá trong thiết kếxe ô tô của Volta."}, body: {"vi":"VF 7 là một bước tiến đột phá trong thiết kếxe ô tô của Volta.","en":"VF 7 là một bước tiến đột phá trong thiết kếxe ô tô của Volta."}, sortOrder: 4 },
    });
  }
  {
  ...
  }
  {
    ...
    await prisma.vehicleModel.upsert({
      where: { id: modelId },
      update: { name: {"vi":"VF 9","en":"VF 9"}, slug: {"vi":"vf-9","en":"vf-9"}, tagline: {"vi":"VF 9 là mẫu xe SUV 7 chỗ hàng đầu của Volta. Với kiểu dáng tinh tế, công nghệ tiên tiến nhất và sự tỉ mỉ trong từng ch","en":"VF 9 là mẫu xe SUV 7 chỗ hàng đầu của Volta. Với kiểu dáng tinh tế, công nghệ tiên tiến nhất và sự tỉ mỉ trong từng ch"}, description: {"vi":"VF 9 là mẫu xe SUV 7 chỗ hàng đầu của Volta. Với kiểu dáng tinh tế, công nghệ tiên tiến nhất và sự tỉ mỉ trong từng chi tiết, VF 9mang đến trải nghiệm đặc biệt cao cấp cho người sở hữu. Vóc dáng bề thế của một chiếc SUV cỡ lớn cùng thiết kế giúp tối ưu tính khí động học để gia tăng quãng đường đi được, đem lại những trải nghiệm đẳng cấp. Thiết kế tối giản mang hơi hướng tương lai nhưng không kém phần tinh tế từ studio danh tiếng Pininfarina đem lại trải nghiệm ấn tượng và cuốn hút từ cái nhìn đầu tiên.","en":"VF 9 là mẫu xe SUV 7 chỗ hàng đầu của Volta. Với kiểu dáng tinh tế, công nghệ tiên tiến nhất và sự tỉ mỉ trong từng chi tiết, VF 9mang đến trải nghiệm đặc biệt cao cấp cho người sở hữu. Vóc dáng bề thế của một chiếc SUV cỡ lớn cùng thiết kế giúp tối ưu tính khí động học để gia tăng quãng đường đi được, đem lại những trải nghiệm đẳng cấp. Thiết kế tối giản mang hơi hướng tương lai nhưng không kém phần tinh tế từ studio danh tiếng Pininfarina đem lại trải nghiệm ấn tượng và cuốn hút từ cái nhìn đầu tiên."}, attributes: [{"key":"range","value":30,"unit":"km"},{"key":"seats","value":7,"unit":"seats"}], published: true, sortOrder: 12 },
      create: { id: modelId, segmentId: segmentIds["suv"], name: {"vi":"VF 9","en":"VF 9"}, slug: {"vi":"vf-9","en":"vf-9"}, tagline: {"vi":"VF 9 là mẫu xe SUV 7 chỗ hàng đầu của Volta. Với kiểu dáng tinh tế, công nghệ tiên tiến nhất và sự tỉ mỉ trong từng ch","en":"VF 9 là mẫu xe SUV 7 chỗ hàng đầu của Volta. Với kiểu dáng tinh tế, công nghệ tiên tiến nhất và sự tỉ mỉ trong từng ch"}, description: {"vi":"VF 9 là mẫu xe SUV 7 chỗ hàng đầu của Volta. Với kiểu dáng tinh tế, công nghệ tiên tiến nhất và sự tỉ mỉ trong từng chi tiết, VF 9mang đến trải nghiệm đặc biệt cao cấp cho người sở hữu. Vóc dáng bề thế của một chiếc SUV cỡ lớn cùng thiết kế giúp tối ưu tính khí động học để gia tăng quãng đường đi được, đem lại những trải nghiệm đẳng cấp. Thiết kế tối giản mang hơi hướng tương lai nhưng không kém phần tinh tế từ studio danh tiếng Pininfarina đem lại trải nghiệm ấn tượng và cuốn hút từ cái nhìn đầu tiên.","en":"VF 9 là mẫu xe SUV 7 chỗ hàng đầu của Volta. Với kiểu dáng tinh tế, công nghệ tiên tiến nhất và sự tỉ mỉ trong từng chi tiết, VF 9mang đến trải nghiệm đặc biệt cao cấp cho người sở hữu. Vóc dáng bề thế của một chiếc SUV cỡ lớn cùng thiết kế giúp tối ưu tính khí động học để gia tăng quãng đường đi được, đem lại những trải nghiệm đẳng cấp. Thiết kế tối giản mang hơi hướng tương lai nhưng không kém phần tinh tế từ studio danh tiếng Pininfarina đem lại trải nghiệm ấn tượng và cuốn hút từ cái nhìn đầu tiên."}, attributes: [{"key":"range","value":30,"unit":"km"},{"key":"seats","value":7,"unit":"seats"}], published: true, sortOrder: 12 },
    });
    await prisma.vehicleVariant.upsert({
    ...
    await prisma.featureSection.upsert({
      ...
      update: { title: {"vi":"So sánh giữa xe Volta VF 9 và xe động cơ đốt trong","en":"So sánh giữa xe Volta VF 9 và xe động cơ đốt trong"}, body: {"vi":"So sánh giữa xe Volta VF 9 và xe động cơ đốt trong","en":"So sánh giữa xe Volta VF 9 và xe động cơ đốt trong"}, sortOrder: 1 },
      create: { id: "seed-feature-vf-9-1", modelId, title: {"vi":"So sánh giữa xe Volta VF 9 và xe động cơ đốt trong","en":"So sánh giữa xe Volta VF 9 và xe động cơ đốt trong"}, body: {"vi":"So sánh giữa xe Volta VF 9 và xe động cơ đốt trong","en":"So sánh giữa xe Volta VF 9 và xe động cơ đốt trong"}, sortOrder: 1 },
    });
    await prisma.featureSection.upsert({
  ...
  }
  {
    ...
    await prisma.vehicleModel.upsert({
      where: { id: modelId },
      update: { name: {"vi":"VF e34","en":"VF e34"}, slug: {"vi":"vf-e34","en":"vf-e34"}, tagline: {"vi":"Volta ra mắt VF e34, mẫu C-SUV với thiết kế tinh tế, thân thiện với người dùng cùng loạt công nghệ thông minh hiện đại","en":"Volta ra mắt VF e34, mẫu C-SUV với thiết kế tinh tế, thân thiện với người dùng cùng loạt công nghệ thông minh hiện đại"}, description: {"vi":"Cùng bạn bứt phá mọi giới hạn Mẫu C-SUV với thiết kế tinh tế Ngoại thất hiện đại thu hút mọi ánh nhìn","en":"Cùng bạn bứt phá mọi giới hạn Mẫu C-SUV với thiết kế tinh tế Ngoại thất hiện đại thu hút mọi ánh nhìn"}, attributes: [], published: true, sortOrder: 13 },
      create: { id: modelId, segmentId: segmentIds["suv"], name: {"vi":"VF e34","en":"VF e34"}, slug: {"vi":"vf-e34","en":"vf-e34"}, tagline: {"vi":"Volta ra mắt VF e34, mẫu C-SUV với thiết kế tinh tế, thân thiện với người dùng cùng loạt công nghệ thông minh hiện đại","en":"Volta ra mắt VF e34, mẫu C-SUV với thiết kế tinh tế, thân thiện với người dùng cùng loạt công nghệ thông minh hiện đại"}, description: {"vi":"Cùng bạn bứt phá mọi giới hạn Mẫu C-SUV với thiết kế tinh tế Ngoại thất hiện đại thu hút mọi ánh nhìn","en":"Cùng bạn bứt phá mọi giới hạn Mẫu C-SUV với thiết kế tinh tế Ngoại thất hiện đại thu hút mọi ánh nhìn"}, attributes: [], published: true, sortOrder: 13 },
    });
    await prisma.vehicleVariant.upsert({
  ...
  await prisma.newsPost.upsert({
    ...
    update: { slug: {"vi":"ban-giao-volta-limo-green-trao-niem-tin-ong-hanh-xanh","en":"ban-giao-volta-limo-green-trao-niem-tin-ong-hanh-xanh"}, title: {"vi":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh","en":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh"}, excerpt: {"vi":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh","en":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh"}, body: {"vi":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh","en":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh"}, published: true, featured: true, publishedAt: new Date() },
    create: { id: "seed-news-2", slug: {"vi":"ban-giao-volta-limo-green-trao-niem-tin-ong-hanh-xanh","en":"ban-giao-volta-limo-green-trao-niem-tin-ong-hanh-xanh"}, title: {"vi":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh","en":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh"}, excerpt: {"vi":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh","en":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh"}, body: {"vi":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh","en":"Bàn Giao Volta Limo Green – Trao Niềm Tin, Đồng Hành Xanh"}, published: true, featured: true, publishedAt: new Date() },
  });
  await prisma.newsPost.upsert({
    where: { id: "seed-news-3" },
    update: { slug: {"vi":"volta-vf-3-lai-thu-tai-ngai-giao-cung-volta-ong-sai-gon","en":"volta-vf-3-lai-thu-tai-ngai-giao-cung-volta-ong-sai-gon"}, title: {"vi":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn","en":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn"}, excerpt: {"vi":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn","en":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn"}, body: {"vi":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn","en":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn"}, published: true, featured: true, publishedAt: new Date() },
    create: { id: "seed-news-3", slug: {"vi":"volta-vf-3-lai-thu-tai-ngai-giao-cung-volta-ong-sai-gon","en":"volta-vf-3-lai-thu-tai-ngai-giao-cung-volta-ong-sai-gon"}, title: {"vi":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn","en":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn"}, excerpt: {"vi":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn","en":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn"}, body: {"vi":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn","en":"Volta VF 3 – Lái thử tại Ngãi Giao Cùng Volta Đông Sài Gòn"}, published: true, featured: true, publishedAt: new Date() },
  });

  // Home commercial grid (T-0045): fleet segment + Metro + move Limo into commercial
  segmentIds["fleet"] = (await prisma.vehicleSegment.upsert({
    where: { lineId_key: { lineId: lineIds["commercial"], key: "fleet" } },
    update: {},
    create: { lineId: lineIds["commercial"], key: "fleet", name: bi("Xe dịch vụ", "Service fleet"), sortOrder: 2 },
  })).id;

  await prisma.vehicleModel.upsert({
    where: { id: "seed-model-metro-ev" },
    update: {
      segmentId: segmentIds["fleet"],
      name: bi("Metro EV", "Metro EV"),
      slug: { vi: "metro-ev", en: "metro-ev" },
      tagline: bi("Xe dịch vụ nội đô", "Urban service EV"),
      published: true,
      sortOrder: 2,
    },
    create: {
      id: "seed-model-metro-ev",
      segmentId: segmentIds["fleet"],
      name: bi("Metro EV", "Metro EV"),
      slug: { vi: "metro-ev", en: "metro-ev" },
      tagline: bi("Xe dịch vụ nội đô", "Urban service EV"),
  ...
  await prisma.vehicleVariant.upsert({
    where: { id: "seed-variant-metro-ev-1" },
    update: { price: 269000000, published: true, sortOrder: 1 },
    create: {
      id: "seed-variant-metro-ev-1",
      modelId: "seed-model-metro-ev",
      name: bi("Tiêu chuẩn", "Standard"),
      price: 269000000,
      published: true,
      sortOrder: 1,
    },
  ...
  await prisma.vehicleModel.update({
    where: { id: "seed-model-limo-green" },
    data: { segmentId: segmentIds["fleet"], sortOrder: 3 },
  });

  console.log("Scraped catalog seed complete (13+ models, home commercial filled).");
}
