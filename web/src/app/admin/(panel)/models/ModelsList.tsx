...
export function ModelsList({
  ...
  const setFilter = (line: string, segment: string) => {
    ...
    router.push(`/admin/models${query.size ? `?${query}` : ""}`);
  };
    ...
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <div className={styles.actions}>
          <Link className={styles.secondaryLink} href="/admin/models/lines">
            {t("lines.manage")}
          </Link>
          <Link className={styles.primaryLink} href="/admin/models/new">
            {t("models.create")}
          </Link>
        </div>
      </header>
        ...
        >
          {models.map((model) => {
            ...
            return (
              <tr key={model.id}>
                <td>
                  <Link href={`/admin/models/${model.id}`}>{model.name.vi}</Link>
                </td>
                ...
                <td>
                  <div className={styles.rowActions}>
                    <Link href={`/admin/models/${model.id}`}>{t("common.edit")}</Link>
                    <ConfirmDelete
